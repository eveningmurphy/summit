...
-- Student ID: 20049423
-- Date: 18/07/2024
-- Description: This script creates the SQL database schema and populates it with initial data for the Summit application.
--              It includes tables for organisation, team, member, proposal, thread, log, and vote.
--              The script also sets autoincrement values and inserts test data for initial setup.
